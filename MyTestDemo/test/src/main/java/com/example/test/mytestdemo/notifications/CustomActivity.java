...
import com.example.test.mytestdemo.notifications.tools.BaseTools;


public class CustomActivity extends BaseNotificationActivity implements OnClickListener{
	/** TAG */
