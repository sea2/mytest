...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void init(Context context) {
        ...
        String filePath = Environment.getExternalStorageDirectory() + "/xiaocaimi/";
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (null != crashDir) {
                FileOutputStream fos = new FileOutputStream(crashDir.getAbsoluteFile() + File.separator + fileName);
