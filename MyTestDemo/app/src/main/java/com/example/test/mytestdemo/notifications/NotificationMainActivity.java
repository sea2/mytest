...
import com.example.test.mytestdemo.notifications.base.BaseNotificationActivity;
...
public class NotificationMainActivity extends BaseNotificationActivity implements OnClickListener {
    ...
    private void initNotify() {
        ...
        mBuilder.setContentTitle("测试标题").setContentText("测试内容").setContentIntent(getDefalutIntent(Notification.FLAG_AUTO_CANCEL))
...
//		//PendingIntent 跳转动作
        ...
        mBuilder.setSmallIcon(R.mipmap.ic_launcher).setTicker("常驻通知来了").setContentTitle("常驻测试").setContentText("使用cancel()方法才可以把我去掉哦").setContentIntent(pendingIntent);
