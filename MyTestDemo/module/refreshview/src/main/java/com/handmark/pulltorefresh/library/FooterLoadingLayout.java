...
import com.xcm91.relation.refreshview.R;
...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    private View line_content_above;
    ...
    private void init(Context context) {
        ...
        line_content_above = (View) findViewById(R.id.line_content_above);
     ...
     * @param isVisibile
     */
    public void setLineAboveMainState(boolean isVisibile) {
        if (line_content_above != null) {
            line_content_above.setVisibility(GONE);
        }
    }
     ...
     * @param colorInt
     */
    public void setLineAboveMainColor(int colorInt) {
        if (line_content_above != null) {
            line_content_above.setBackgroundColor(colorInt);
        }
    }
